...
fn main() {
  ...
  let tls_instance = messages::Instance { app_id: String::from("app_1"), address: String::from("127.0.0.1:1026") };
  ...
  let tls_instance2 = messages::Instance { app_id: String::from("app_2"), address: String::from("127.0.0.1:1026") };
