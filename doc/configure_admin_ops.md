...
flags. See `doc/configure.md#h2-flood-detection-thresholds` for the
catalogue.
...
Source: `HttpsSession::upgrade_handshake` (`lib/src/https.rs:481`).
Documented in `doc/configure.md:3059`.
