...
| `command_buffer_size`         | size, in bytes, of the buffer used by the main process to handle commands. Must not exceed `max_command_buffer_size`; config load is rejected otherwise (`ConfigError::CommandBufferSizeExceedsMax`, sozu-proxy/sozu#1416).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                           |
