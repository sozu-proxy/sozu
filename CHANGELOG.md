...
- **MSRV (1.85.0) build gate added.** A dedicated job builds the workspace with `--all-features --locked` against the advertised minimum supported Rust version (`Cargo.toml rust-version = "1.85.0"`), independent of the `1.88.0` everyday-development pin in `rust-toolchain`. See [`0b73c8a1`](https://github.com/sozu-proxy/sozu/commit/0b73c8a1).
