...
use crate::{
    ...
    proto::command::{
        request::RequestType, ActivateListener, AddBackend, AddCertificate, AlpnProtocol,
        CertificateAndKey, Cluster, HttpListenerConfig, HttpsListenerConfig, ListenerType,
...
impl ListenerBuilder {
    ...
    pub fn with_public_address<S>(mut self, public_address: Option<S>) -> Self
    where
        S: ToString,
    {
